...
DEFAULT_INSTRUCTIONS = {
    ...
    "job_matching": (
        ...
        "- domain_relevance: Does the candidate have experience in the functional domain of the ROLE "
        "(e.g. data analytics, software engineering, marketing) rather than the company's industry? "
        "A data analyst applying to a legal firm should be judged on data analytics experience, not legal experience. "
        "1=unrelated function, 2=tangential, 3=adjacent, 4=same functional domain, 5=exact match\n"
