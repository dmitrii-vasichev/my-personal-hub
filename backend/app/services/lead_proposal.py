...
9. CTA — the last paragraph MUST be a short question about the specific automation \
you described. See CTA RULES at the end of this prompt — this is critical.
...
# CTA RULES — CRITICAL, READ CAREFULLY

The LAST paragraph before the signature MUST be a SHORT QUESTION (1 sentence, \
max 15 words) that the reader can answer with a single word "да" or "интересно".

MANDATORY requirements:
- MUST be a question ending with "?" — NOT a statement, NOT a request.
- MUST reference the SPECIFIC automation you described in the email body. \
If you wrote about automatic SMS reminders — ask about SMS reminders, \
not about "optimization" or "details".
- MUST be answerable with one word. The reader should just reply "да".

FORBIDDEN CTA — if your CTA matches ANY of these patterns, REWRITE IT:
- "дайте знать" / "let me know" — this is a statement, not a question
- "расскажу подробнее" / "I'll tell you more" — vague, no specific action
- "с радостью / с удовольствием" — filler, adds nothing
- "буду рад обсудить" / "happy to discuss" — too vague
- "запишитесь на консультацию" / "book a consultation" — sales funnel language
- "когда вам удобно?" / "when are you free?" — puts work on recipient
- any Calendly links or booking forms

GOOD CTA examples (vary, do NOT copy verbatim):
- "Хотите — покажу, как такие напоминания работали бы для [business name]?"
- "Стоит показать, как это выглядит на практике?"
- "Интересно посмотреть, как это могло бы работать у вас?"
- "Worth a quick look at how this could work for [business name]?"

SELF-CHECK: Before outputting, verify your CTA ends with "?" and does NOT \
contain "дайте знать", "расскажу подробнее", or "буду рад".
"""
